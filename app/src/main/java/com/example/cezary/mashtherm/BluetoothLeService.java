...
public class BluetoothLeService extends Service {
    ...
    public final static ParcelUuid ParcelUuid_ThermoNRF52832_Service =
            ParcelUuid.fromString(Thermo_NRF52832);
    public final static UUID Thermo_NRF52832_Service =
            UUID.fromString(Thermo_NRF52832);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            for(byte byteChar : data) {
                ...
                Log.v(TAG, String.format("%02d ", byteChar));
            }
            intent.putExtra(EXTRA_DATA, new String(data) + stringBuilder.toString());
        }*/
        sendBroadcast(intent);
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if (UUID.fromString(Thermo_NRF52832).equals(characteristic.getUuid())) {
